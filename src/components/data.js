...
export const deleteCardPopup = document.querySelector('#delete-popup');
...
export const deleteCardForm = document.forms["deleteForm"];
...
export const deleteCardClose = document.querySelector('#delete-close');
...
export const submitButtonDelete = deleteCardPopup.querySelector('.edit-form__submit-button');
